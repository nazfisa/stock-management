            ...
            <tr>
              ...
              <tr>
                <td class="auto-style1">
                    <asp:Button ID="companyNameSaveButton" runat="server" Text="Save" OnClick="companyNameSaveButton_Click" />
                </td>
                <td class="auto-style1">
                    <asp:Label ID="companyOutputShowLabel" runat="server"></asp:Label>
                </td>
            </tr>
        </table>
      </fieldset>
        
         <asp:GridView ID="companyGridView" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal" Width="552px">
...
<asp:TemplateField HeaderText="Company Name"><ItemTemplate>
